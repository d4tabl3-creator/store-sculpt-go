  ...
  steps: [
    {
      ...
      action: { label: "Ver mis productos", labelEn: "View my products", to: "/tienda/$id" },
    ...
    },
    {
      ...
      action: { label: "Editar precios", labelEn: "Edit prices", to: "/tienda/$id" },
      check: { kind: "manual" },
    ...
    },
    {
      ...
      action: { label: "Configurar cobros", labelEn: "Set up payments", to: "/tienda/$id" },
    ...
    },
    {
      ...
      action: { label: "Publicar", labelEn: "Publish", to: "/tienda/$id" },
