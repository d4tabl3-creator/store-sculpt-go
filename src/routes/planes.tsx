        ...
        {selected ? (
          ...
          <>
            ...
            <div className="mt-6 grid gap-5 md:grid-cols-2">
              {PLANS.map((p) => (
                <div key={p.id} className={"relative rounded-3xl border p-7 transition-all " + (p.featured ? "border-primary bg-gradient-to-br from-primary to-action text-primary-foreground shadow-pop" : "border-border bg-card")}>
                  {p.featured && (
